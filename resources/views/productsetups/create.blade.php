      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            @endif
              <h4 class="card-title">ÜRÜN KURULUM TABLOSU VERİ EKLEME</h4>
              <p class="card-category">Bu tablodan ürün kurulum tablosu için veri ekleme işlemleri yapabilirsiniz.</p>
            </div>
            <div class="card-body">
              <form method="post" action="{{route('productsetups.store')}}">
                {{ csrf_field() }}
                <div class="row">
                  <div class="col-md-12">
